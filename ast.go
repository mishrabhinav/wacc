...
func appendIncludedFiles(ast *AST, ifm *IncludeFilesMap) {
...
func setupIncludeFileMap(baseFile string) *IncludeFilesMap {
	dir := filepath.Dir(baseFile)
	ifm := &IncludeFilesMap{dir: dir}
	ifm.Include(baseFile)
...
func ParseAST(wacc *WACC, ifm *IncludeFilesMap) (ast *AST, err error) {
